...
setTimeout(()=>clearInterval(flowerInterval),25000);
...
const sparkInterval=setInterval(createSpark,120);
setTimeout(()=>clearInterval(sparkInterval),25000);
...
const wishInterval=setInterval(createWish,180);
setTimeout(()=>clearInterval(wishInterval),25000);